...
AppearanceSettings::AppearanceSettings(QWidget* parent) : QWidget(parent)
{
    ...
    m_knsConfigFileName = QLatin1String("Yakuake2ndScreen.knsrc");
    ...
    // through KNS3.
    m_localSkinsDir = QStandardPaths::writableLocation(QStandardPaths::GenericDataLocation) + QStringLiteral("/Yakuake2ndScreen/skins/");
    m_knsSkinDir = QStandardPaths::writableLocation(QStandardPaths::GenericDataLocation) + QStringLiteral("/Yakuake2ndScreen/kns_skins/");
...
void AppearanceSettings::populateSkinList()
{
    ...
    allSkinLocations << QStandardPaths::locateAll(QStandardPaths::GenericDataLocation, QStringLiteral("/Yakuake2ndScreen/skins/"), QStandardPaths::LocateDirectory);
    allSkinLocations << QStandardPaths::locateAll(QStandardPaths::GenericDataLocation, QStringLiteral("/Yakuake2ndScreen/kns_skins/"), QStandardPaths::LocateDirectory);
...
bool AppearanceSettings::validateSkin(const QString& skinId, bool kns)
{
    ...
    QString titlePath = QStringLiteral("/opt/Yakuake2ndScreen/share/Yakuake2ndScreen/") + dir + skinId + QStringLiteral("/title.skin");
    QString tabsPath = QStringLiteral("/opt/Yakuake2ndScreen/share/Yakuake2ndScreen/") + dir + skinId + QStringLiteral("/tabs.skin");
