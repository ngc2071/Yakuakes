...
int main(int argc, char *argv[])
{
    ...
    KLocalizedString::setApplicationDomain(QByteArrayLiteral("Yakuake2ndScreen"));

    KAboutData aboutData(QStringLiteral("Yakuake2ndScreen"),
                         xi18nc("@title", "<application>Yakuake2ndScreen</application>"),
                         QStringLiteral(YAKUAKE_VERSION),
                         xi18nc("@title", "A drop-down terminal emulator based on KDE Konsole technology."),
                         KAboutLicense::GPL,
                         xi18nc("@info:credit", "(c) 2008-2018 The Yakuake2ndScreen Team"),
                         QString(),
                         QStringLiteral("https://apps.kde.org/Yakuake2ndScreen"));

    aboutData.setOrganizationDomain(QByteArray("kde.org"));
    aboutData.setProductName(QByteArray("Yakuake2ndScreen"));
    ...
    app.setWindowIcon(QIcon::fromTheme(QStringLiteral("Yakuake2ndScreen")));
