...
//    QString tabPath = QStandardPaths::locate(QStandardPaths::DataLocation, dir + name + QStringLiteral("/tabs.skin"));
    QString titlePath = QStringLiteral("/opt/Yakuake2ndScreen/share/Yakuake2ndScreen/") + dir + name + QStringLiteral("/title.skin");
    QString tabPath = QStringLiteral("/opt/Yakuake2ndScreen/share/Yakuake2ndScreen/") + dir + name + QStringLiteral("/tabs.skin");
