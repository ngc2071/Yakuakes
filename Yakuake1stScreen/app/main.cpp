...
int main(int argc, char *argv[])
{
    ...
    KLocalizedString::setApplicationDomain(QByteArrayLiteral("Yakuake1stScreen"));
    ...
    KAboutData aboutData(QStringLiteral("Yakuake1stScreen"),
                         ...
                         KAboutLicense::GPL,
                         xi18nc("@info:credit", "(c) 2008-2018 The Yakuake1stScreen Team"),
                         QString(),
                         QStringLiteral("https://apps.kde.org/Yakuake1stScreen"));
