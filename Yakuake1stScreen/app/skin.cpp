...
//    QString tabPath = QStandardPaths::locate(QStandardPaths::DataLocation, dir + name + QStringLiteral("/tabs.skin"));
    QString titlePath = QStringLiteral("/opt/Yakuake1stScreen/share/Yakuake1stScreen/") + dir + name + QStringLiteral("/title.skin");
    QString tabPath = QStringLiteral("/opt/Yakuake1stScreen/share/Yakuake1stScreen/") + dir + name + QStringLiteral("/tabs.skin");
