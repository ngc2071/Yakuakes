...
{
    QDBusConnection::sessionBus().registerObject(QStringLiteral("/Yakuake1stScreen/sessions"), this, QDBusConnection::ExportScriptableSlots);
...
static void warnAboutDBus()
{
    ...
    if (show_disallow_certain_dbus_methods_message) {
        KNotification::event(
            ...
            QStringLiteral("Yakuake1stScreen D-Bus Warning"),
            i18n("The D-Bus method runCommand was just used.  There are security concerns about allowing these methods to be public.  If desired, these "
                 "methods can be changed to internal use only by re-compiling Yakuake1stScreen. <p>This warning will only show once for this Yakuake1stScreen instance.</p>"));
