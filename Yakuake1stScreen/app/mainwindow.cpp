...
void MainWindow::applySettings()
{
    ...
    if (!Settings::showSystrayIcon() && m_notifierItem) {
        ...
        m_notifierItem->setIconByName(QStringLiteral("Yakuake1stScreen"));
...
void MainWindow::applySkin()
{
    ...
    if (!gotSkin)
    {
        KMessageBox::error(parentWidget(),
            xi18nc("@info", "<application>Yakuake1stScreen</application> was unable to load a skin. It is likely that it was installed incorrectly.<nl/><nl/>"
...
void MainWindow::updateTrayTooltip()
{
    ...
    if (!shortcuts.isEmpty()) {
        ...
        m_notifierItem->setToolTip(QStringLiteral("Yakuake1stScreen"),
                QStringLiteral("Yakuake1stScreen"), xi18nc("@info", "Press <shortcut>%1</shortcut> to open", shortcut));
    }
