...
AppearanceSettings::AppearanceSettings(QWidget* parent) : QWidget(parent)
{
    ...
    m_knsConfigFileName = QLatin1String("Yakuake1stScreen.knsrc");
    ...
    // through KNS3.
    m_localSkinsDir = QStandardPaths::writableLocation(QStandardPaths::GenericDataLocation) + QStringLiteral("/Yakuake1stScreen/skins/");
    m_knsSkinDir = QStandardPaths::writableLocation(QStandardPaths::GenericDataLocation) + QStringLiteral("/Yakuake1stScreen/kns_skins/");
...
void AppearanceSettings::populateSkinList()
{
    ...
    allSkinLocations << QStandardPaths::locateAll(QStandardPaths::GenericDataLocation, QStringLiteral("/Yakuake1stScreen/skins/"), QStandardPaths::LocateDirectory);
    allSkinLocations << QStandardPaths::locateAll(QStandardPaths::GenericDataLocation, QStringLiteral("/Yakuake1stScreen/kns_skins/"), QStandardPaths::LocateDirectory);
...
bool AppearanceSettings::validateSkin(const QString& skinId, bool kns)
{
    ...
    QString titlePath = QStringLiteral("/opt/Yakuake1stScreen/share/Yakuake1stScreen/") + dir + skinId + QStringLiteral("/title.skin");
    QString tabsPath = QStringLiteral("/opt/Yakuake1stScreen/share/Yakuake1stScreen/") + dir + skinId + QStringLiteral("/tabs.skin");
