...
void MainWindow::applySettings()
{
    ...
    if (!Settings::showSystrayIcon() && m_notifierItem) {
        ...
        m_notifierItem->setIconByName(QStringLiteral("Yakuake3rdScreen"));
...
void MainWindow::applySkin()
{
    ...
    if (!gotSkin)
    {
        KMessageBox::error(parentWidget(),
            xi18nc("@info", "<application>Yakuake3rdScreen</application> was unable to load a skin. It is likely that it was installed incorrectly.<nl/><nl/>"
...
void MainWindow::updateTrayTooltip()
{
    ...
    if (!shortcuts.isEmpty()) {
        ...
        m_notifierItem->setToolTip(QStringLiteral("Yakuake3rdScreen"),
                QStringLiteral("Yakuake3rdScreen"), xi18nc("@info", "Press <shortcut>%1</shortcut> to open", shortcut));
    }
