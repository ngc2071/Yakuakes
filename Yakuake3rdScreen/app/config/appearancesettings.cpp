...
AppearanceSettings::AppearanceSettings(QWidget* parent) : QWidget(parent)
{
    ...
    m_knsConfigFileName = QLatin1String("Yakuake3rdScreen.knsrc");
    ...
    // through KNS3.
    m_localSkinsDir = QStandardPaths::writableLocation(QStandardPaths::GenericDataLocation) + QStringLiteral("/Yakuake3rdScreen/skins/");
    m_knsSkinDir = QStandardPaths::writableLocation(QStandardPaths::GenericDataLocation) + QStringLiteral("/Yakuake3rdScreen/kns_skins/");
...
void AppearanceSettings::populateSkinList()
{
    ...
    allSkinLocations << QStandardPaths::locateAll(QStandardPaths::GenericDataLocation, QStringLiteral("/Yakuake3rdScreen/skins/"), QStandardPaths::LocateDirectory);
    allSkinLocations << QStandardPaths::locateAll(QStandardPaths::GenericDataLocation, QStringLiteral("/Yakuake3rdScreen/kns_skins/"), QStandardPaths::LocateDirectory);
...
bool AppearanceSettings::validateSkin(const QString& skinId, bool kns)
{
    ...
    QString titlePath = QStringLiteral("/opt/Yakuake3rdScreen/share/Yakuake3rdScreen/") + dir + skinId + QStringLiteral("/title.skin");
    QString tabsPath = QStringLiteral("/opt/Yakuake3rdScreen/share/Yakuake3rdScreen/") + dir + skinId + QStringLiteral("/tabs.skin");
