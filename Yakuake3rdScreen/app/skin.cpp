...
//    QString tabPath = QStandardPaths::locate(QStandardPaths::DataLocation, dir + name + QStringLiteral("/tabs.skin"));
    QString titlePath = QStringLiteral("/opt/Yakuake3rdScreen/share/Yakuake3rdScreen/") + dir + name + QStringLiteral("/title.skin");
    QString tabPath = QStringLiteral("/opt/Yakuake3rdScreen/share/Yakuake3rdScreen/") + dir + name + QStringLiteral("/tabs.skin");
