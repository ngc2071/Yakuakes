...
int main(int argc, char *argv[])
{
    ...
    KLocalizedString::setApplicationDomain(QByteArrayLiteral("Yakuake3rdScreen"));

    KAboutData aboutData(QStringLiteral("Yakuake3rdScreen"),
                         xi18nc("@title", "<application>Yakuake3rdScreen</application>"),
                         QStringLiteral(YAKUAKE_VERSION),
                         xi18nc("@title", "A drop-down terminal emulator based on KDE Konsole technology."),
                         KAboutLicense::GPL,
                         xi18nc("@info:credit", "(c) 2008-2018 The Yakuake3rdScreen Team"),
                         QString(),
                         QStringLiteral("https://apps.kde.org/Yakuake3rdScreen"));

    aboutData.setOrganizationDomain(QByteArray("kde.org"));
    aboutData.setProductName(QByteArray("Yakuake3rdScreen"));
    ...
    app.setWindowIcon(QIcon::fromTheme(QStringLiteral("Yakuake3rdScreen")));
